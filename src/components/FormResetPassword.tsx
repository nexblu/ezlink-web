    ...
    return (
        <div>
            <form className="w-full">
                ...
                <button type="submit" className="w-full mt-3 mb-3 bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">{loading ? 'Loading ...' : 'Reset Password'}</button>
